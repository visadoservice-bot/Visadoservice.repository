            ...
            <div className="bg-white rounded-2xl border border-slate-200/90 p-5 sm:p-9 shadow-sm hover:shadow-md transition-shadow">
              ...
              {!isSubmitted ? (
                <form onSubmit={handleWhatsAppSubmit} className="space-y-4 sm:space-y-5">
                  ...
                  <div>
                    <label id="dest-label" className="block text-xs font-bold text-slate-800 mb-1.5">
                      {currentLang === 'ar' ? '1. الوجهة المطلوبة *' : '1. Destination ou service souhaité *'}
                    </label>
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2" role="group" aria-labelledby="dest-label">
                      {quickDestinations.map((dest) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-2 rounded-xl text-xs font-semibold text-start border transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 ${
                              isSelected
                  ...
                  <div>
                    <label id="profile-label" className="block text-xs font-bold text-slate-800 mb-1.5">
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2" role="group" aria-labelledby="profile-label">
                      {quickProfiles.map((prof) => {
                        ...
                        return (
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-xs font-semibold border transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 ${
                              isSelected
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-3 text-base sm:text-sm bg-slate-50/70 border border-slate-300 rounded-xl focus:bg-white focus:border-blue-600 focus:ring-3 focus:ring-blue-100 focus-visible:outline-none text-slate-900 transition-all placeholder:text-slate-500"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2.5 text-base sm:text-sm bg-slate-50/70 border border-slate-300 rounded-xl focus:bg-white focus:border-blue-600 focus:ring-3 focus:ring-blue-100 focus-visible:outline-none text-slate-900 transition-all resize-none placeholder:text-slate-500"
                    />
                  </div>
                  ...
                  <div className="pt-2 space-y-2.5">
                    <button
                      type="submit"
                      className="w-full bg-[#25D366] hover:bg-[#20ba5a] active:bg-[#1da851] text-white font-bold text-sm sm:text-base py-3.5 px-6 rounded-xl shadow-md shadow-emerald-500/20 active:scale-[0.99] transition-all flex items-center justify-center gap-2.5 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2"
                    >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-2 pt-1">
                      <button
                        ...
                        className="text-xs text-slate-600 hover:text-blue-700 underline font-medium cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 rounded-sm"
                      >
                      ...
                      <a
                        href={`tel:${siteConfig.phoneRaw}`}
                        className="text-xs text-blue-700 hover:text-blue-900 font-semibold inline-flex items-center gap-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 rounded-sm"
                      >
