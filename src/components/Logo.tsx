  ...
  return (
    <div className={`flex items-center gap-2 sm:gap-2.5 group ${className}`} dir="ltr">
      ...
      {!hasError && siteConfig.logoUrl ? (
        <div className={`rounded-xl p-1 flex items-center justify-center shrink-0 transition-transform duration-200 group-hover:scale-105 ${
          isDark 
            ? 'bg-white/10 border border-white/20' 
            : 'bg-white border border-[#E8EAED] shadow-xs'
        }`}>
          <img
